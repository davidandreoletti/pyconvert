...
def main():
    ...
    parser.add_option(  "--md",
                      ...
                      default="./",
                      help="Directory containing media files to convert. Default value: ./")
    ...
    masterJob = convertJobCreator.createJobFromMediaDirectory(options.mediaDirectoryPath, videoFileExtensions, imageFileExtensions)
